	...
	public mainWindow(String username) throws ParseException{
		...
		searchButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					sd = new searchDialog(priceSpinner.getValue().toString(), yearSpinner.getValue().toString(), ((modelSelected != (null))?modelSelected:"All"), makeSelected, username);
					dispose();
		...
		priceSpinner.setModel(new SpinnerListModel(new String[] {"All", "< $5,000", "> $5,000", "< $10,000", "> $10,000", "< $20,000", "> $20,000", "< $50,000", "> $50,000", "< $100,000", "> $100,000", "< $500,000", "> $500,000"}));
