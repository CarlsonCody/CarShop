...
public class viewCar extends JFrame {
	...
	public viewCar(ArrayList<String> info) throws Exception {
        ...
        // Create a new ImageIcon object using the URL of the image
        ...
        // Resize the image to the dimensions of the JLabel
        ...
        // Set the ImageIcon object as the icon of the JLabel object
        label.setIcon(resizedIcon);
        
        
        // Set the horizontal and vertical alignment of the JLabel to CENTER
