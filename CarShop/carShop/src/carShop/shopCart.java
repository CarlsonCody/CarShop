...
public class shopCart extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					shopCart frame = new shopCart("blanklev");
	...
	public shopCart(String username) {
        ...
        // Set the View column to use a button renderer and editor
        table.getColumnModel().getColumn(4).setCellRenderer(new ButtonRenderer());
        table.getColumnModel().getColumn(4).setCellEditor(new ButtonEditor(new JCheckBox()));

        // Set the Compare column to use a checkbox renderer and editor
        ...
        // Set the Delete column to use a button renderer and editor
        ...
        compareButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
                ...
                if(selectedForCompare.size() >= 3) {
                	JOptionPane.showMessageDialog(null, "Please select two items only!", "Error", JOptionPane.WARNING_MESSAGE);
                }
                else {
    ...
    public Object getCellEditorValue() {
        ...
        if (isPushed && label.equals("Delete")) {
        	...
        	obj.deleteFromCart(obj.getUserID(username), selectedCar[1], Integer.parseInt(selectedCar[2]), Integer.parseInt(selectedCar[3]));
        }
...
// Custom cell editor for checkboxes
