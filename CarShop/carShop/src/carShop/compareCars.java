...
public class compareCars extends JFrame {
	...
	public compareCars(ArrayList<String[]> selectedCars) throws MalformedURLException, Exception {
		...
		//First car
        URL url1 = new URL(BingWebSearch.searchFor("Stock " + car1.get(2) + " " + car1.get(0) + " " + car1.get(1) + " " + car1.get(11)));
        ...
        //Second car
        URL url2 = new URL(BingWebSearch.searchFor("Stock " + car2.get(2) + " " + car2.get(0) + " " + car2.get(1) + " " + car2.get(11)));
